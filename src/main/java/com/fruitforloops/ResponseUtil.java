...
import com.fruitforloops.model.beans.ResponseBean;
...
public final class ResponseUtil
{
	...
	public static void sendJSON(HttpServletResponse response, int httpStatusCode, String message, Object data) throws IOException
	{
	...
	public static void sendXML(HttpServletResponse response, int httpStatusCode, String message, Object data, Class<?>... additionalContexts) throws IOException, JAXBException
	{
		response.setStatus(httpStatusCode);
		sendXML(response, message, data, additionalContexts);
	}
	public static void sendXML(HttpServletResponse response, String message, Object data, Class<?>... additionalContexts) throws IOException, JAXBException
	{
